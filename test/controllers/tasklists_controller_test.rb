...
class TasklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tasklist" do
    assert_difference("Tasklist.count") do
      post tasklists_url, params: { tasklist: { deadline: @tasklist.deadline, description: @tasklist.description, title: @tasklist.title, user_id: @tasklist.user_id } }
    end
  ...
  test "should update tasklist" do
    patch tasklist_url(@tasklist), params: { tasklist: { deadline: @tasklist.deadline, description: @tasklist.description, title: @tasklist.title, user_id: @tasklist.user_id } }
